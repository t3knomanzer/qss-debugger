...
setup(
    ...
    packages=['.venv.Lib.distutils', '.venv.Lib.encodings', '.venv.Lib.site-packages.pip',
              ...
              '.venv.Lib.site-packages.PySide', '.venv.Lib.site-packages.PySide.scripts',
              '.venv.Lib.site-packages.PySide.examples.hyperui.hyperuilib',
              '.venv.Lib.site-packages.PySide.examples.hyperui.hyperuilib.shared',
              '.venv.Lib.site-packages.PySide.examples.hyperui.hyperuilib.resource',
              '.venv.Lib.site-packages.pysideuic', '.venv.Lib.site-packages.pysideuic.port_v2',
              '.venv.Lib.site-packages.pysideuic.Compiler', '.venv.Lib.site-packages.setuptools',
